...
public class LeftRadiusImageView extends ImageView {

    public LeftRadiusImageView(Context context, AttributeSet attrs,
                               int defStyleAttr) {
    ...
    public LeftRadiusImageView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }
