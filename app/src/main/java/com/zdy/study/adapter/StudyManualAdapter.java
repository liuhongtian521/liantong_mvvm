...
public class StudyManualAdapter extends BaseQuickAdapter<StuyManualListBean.RecordsBean, BaseViewHolder>  {

    private SMAdapterCallBack callBack;
    private View fouseView;
    private int fousePosition;

    public StudyManualAdapter(List<StuyManualListBean.RecordsBean> data, SMAdapterCallBack callBack){
    ...
    @Override
    protected void convert(BaseViewHolder baseViewHolder, StuyManualListBean.RecordsBean item) {
        baseViewHolder.setText(R.id.tv_title, item.getClassesName());
