...
public final class EncryptUtils {
    ...
    public final static String TRANSFORMATION = "DES/CBC/PKCS5Padding";//DES是加密方式 CBC是工作模式 PKCS5Padding是填充模式
    public final static String IVPARAMETERSPEC = "12345678";////初始化向量参数，AES 为16bytes. DES 为8bytes.
    public final static String ALGORITHM = "DES";//DES是加密方式
    public static final String SHA1PRNG = "SHA1PRNG";//// SHA1PRNG 强随机种子算法, 要区别4.2以上版本的调用方法
   ...
   /* public static String encrypt(String strDataToEncrypt, String keyStr) {
        ...
        try {
            ...
            strResult = new String(Base64.encode(enc, Base64.DEFAULT));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    *//**
     ...
     *//*
    public static String decrypt(String strDataToDecrypt, String keyStr) {
        byte[] key = keyStr.getBytes();
        Provider sunJCE = new com.sun.crypto.provider.SunJCE();
        Security.addProvider(sunJCE);
        ...
        try {
            ...
            byte[] dec = Base64.decode(strDataToDecrypt, Base64.DEFAULT);
