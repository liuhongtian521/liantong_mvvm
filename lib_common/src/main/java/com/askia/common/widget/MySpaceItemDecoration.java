...
public class MySpaceItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param layoutManager
     */
    public MySpaceItemDecoration(int leftRight, int topBottom, int headItemCount, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public MySpaceItemDecoration(int space,boolean includeEdge, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public MySpaceItemDecoration(int space,int headItemCount,boolean includeEdge, @LayoutManager int layoutManager) {
        this.space = space;
        this.headItemCount = headItemCount;
     ...
     * @param layoutManager
     */
    public MySpaceItemDecoration(int space,int headItemCount, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public MySpaceItemDecoration(int space, @LayoutManager int layoutManager) {
