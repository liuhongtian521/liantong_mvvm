 ...
 * @date 2019/11/25
 */
public class LoginPhotoListShowView extends RelativeLayout {
    ImageView img_one;
    ImageView img_two;
    ...
    public LoginPhotoListShowView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        Log.e("TagSnake", "create");
    ...
    public void setList() {
        ...
        if (list.size() > 0)
            list.clear();
        list.add(R.drawable.icon_write_one);
        list.add(R.drawable.icon_write_two);
...
//        Log.e("TagSnake", "a2");
    ...
    public void start() {
        if (list != null) {
            ...
            img_one.setImageResource(R.drawable.icon_write_one);
        }
    }
...
//            setout.addAnimation(animation3);
    ...
    public void setImg() {
        Glide.with(context).load(list.get(index)).into(img_two);
    }
