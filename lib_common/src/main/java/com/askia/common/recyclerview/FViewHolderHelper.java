...
/**
 * @ClassName FViewHolderHelper
 * @author  WangHuanyu
 * @todo 为AdapterView和RecyclerView的item设置常见属性（链式编程）
 * @date 2016/9/13 16:18
 */
public class FViewHolderHelper implements View.OnClickListener, View.OnLongClickListener, CompoundButton.OnCheckedChangeListener {
    protected final SparseArray<View> mViews;
    protected FOnItemChildClickListener mOnItemChildClickListener;
    protected FOnItemChildLongClickListener mOnItemChildLongClickListener;
    protected FOnItemChildCheckedChangeListener mOnItemChildCheckedChangeListener;
    protected View mConvertView;
    protected Context mContext;
    protected int mPosition;
    protected FRecyclerViewHolder mRecyclerViewHolder;
    ...
    public FViewHolderHelper(ViewGroup adapterView, View convertView) {
    ...
    public FViewHolderHelper(RecyclerView recyclerView, View convertView) {
        mViews = new SparseArray<>();
    ...
    public void setRecyclerViewHolder(FRecyclerViewHolder recyclerViewHolder) {
        mRecyclerViewHolder = recyclerViewHolder;
    }

    public FRecyclerViewHolder getRecyclerViewHolder() {
     ...
     * @return
     */
    public FViewHolderHelper setText(@IdRes int viewId, CharSequence text) {
     ...
     * @return
     */
    public FViewHolderHelper setText(@IdRes int viewId, @StringRes int stringResId) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public FViewHolderHelper setHtml(@IdRes int viewId, String source) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public FViewHolderHelper setChecked(@IdRes int viewId, boolean checked) {
        Checkable view = getView(viewId);
        view.setChecked(checked);
        return this;
    }

    public FViewHolderHelper setTag(@IdRes int viewId, Object tag) {
        View view = getView(viewId);
        view.setTag(tag);
        return this;
    }

    public FViewHolderHelper setTag(@IdRes int viewId, int key, Object tag) {
        View view = getView(viewId);
        view.setTag(key, tag);
        return this;
    }

    public FViewHolderHelper setVisibility(@IdRes int viewId, int visibility) {
        View view = getView(viewId);
        view.setVisibility(visibility);
        return this;
    }

    public FViewHolderHelper setImageBitmap(@IdRes int viewId, Bitmap bitmap) {
        ImageView view = getView(viewId);
        view.setImageBitmap(bitmap);
        return this;
    }

    public FViewHolderHelper setImageDrawable(@IdRes int viewId, Drawable drawable) {
        ImageView view = getView(viewId);
     ...
     * @return
     */
    public FViewHolderHelper setTextColorRes(@IdRes int viewId, @ColorRes int textColorResId) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public FViewHolderHelper setTextColor(@IdRes int viewId, int textColor) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public FViewHolderHelper setBackgroundRes(@IdRes int viewId, int backgroundResId) {
        View view = getView(viewId);
     ...
     * @return
     */
    public FViewHolderHelper setBackgroundColor(@IdRes int viewId, int color) {
        View view = getView(viewId);
     ...
     * @return
     */
    public FViewHolderHelper setBackgroundColorRes(@IdRes int viewId, @ColorRes int colorResId) {
        View view = getView(viewId);
     ...
     * @return
     */
    public FViewHolderHelper setImageResource(@IdRes int viewId, @DrawableRes int imageResId) {
        ImageView view = getView(viewId);
